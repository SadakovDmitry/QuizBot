...
quiz_sets = [
    # Квиз №1 — Внеучебка
    [
        {"question": "Какие крупные внеучебные мероприятия проводятся в МФТИ?", "options": ["Спартакиада", "Матч века", "День Физика", "Все\nперечисленные"], "answer": 3},
        {"question": "Сколько дней обычно длятся Дни Физтеха?", "options": ["1", "2", "3", "4"], "answer": 3},
        {"question": "Какое мероприятие традиционно завершает Дни Физтеха?", "options": ["Дискотека", "Музыкальный\nконцерт", "Турнир", "Пенная\nвечеринка"], "answer": 1},
        {"question": "Когда проводится День первокурсника в МФТИ?", "options": ["30 августа", "31 августа", "1 сентября", "2 сентября"], "answer": 2},
        {"question": "Что такое Матч века в МФТИ?", "options": ["Непрерывный\n24-часовой матч", "Матч победителей\nтурнира", "Встреча\nвыпускников", "Обычный матч\nмежду командами"], "answer": 0},
        {"question": "Кто может участвовать в организации мероприятий в МФТИ?", "options": ["Любой желающий\nстудент", "Только студенты\nстарше второго курса", "Только с опытом\nорганизации", "Только сотрудники\nМФТИ"], "answer": 0},
        {"question": "Сколько человек максимум собиралось на День рождение физтех-школы в МФТИ?", "options": ["Около 2500", "Около 2000", "Около 1500", "Около 1000"], "answer": 0},
        {"question": "Какой из праздников не отмечается в МФТИ?", "options": ["23 февраля", "Хэллоуин", "1 апреля", "8 марта"], "answer": 2},
        {"question": "Какая конференция МФТИ включает секции по бизнесу и технологическому предпринимательству?", "options": ["Всероссийская\nнаучная конференция", "Startup\nVillage", "Форум\n«Территория»", "Технопарк"], "answer": 0},
        {"question": "Какое мероприятие помогает студентам наладить контакт с научными центрами и потенциальными работодателями?", "options": ["Карьерный\nфорсаж", "Startup\nVillage", "Олимпиада\n«Физтех»", "Научная\nконференция"], "answer": 0},
    ],
    ...
    [
        ...
        {"question": "Какое направление является наиболее востребованным у выпускников МФТИ согласно данным «Вузопедия»?", "options": ["Разработка ПО и\nинф. безопасность", "Химическая\nпромышленность", "Финансовый\nанализ", "Архитектура и\nдизайн"], "answer": 0},
        {"question": "В каких ролях чаще всего начинают работать выпускники МФТИ?", "options": ["Инженер,\nпрограммист,\nконструктор", "Юрист,\nэкономист,\nменеджер", "Врач,\nучитель,\nжурналист", "Маркетолог,\nдизайнер,\nHR"], "answer": 0},
        ...
        {"question": "Где студенты МФТИ могут проходить стажировку по направлению «Когнитивные технологии»?", "options": ["Google", "Cognitive\nTechnologies", "Yandex", "IBM"], "answer": 1},
        ...
        {"question": "Из каких профессий часто приходят предложения о работе студентам МФТИ ещё во время учёбы?", "options": ["Аналитик данных\nи статистик", "Водитель\nи курьер", "Продавец\nи кассир", "Художник\nи скульптор"], "answer": 0},
    ],

    # Квиз №3 — Довуз
    [
        {"question": "Какая олимпиада даёт льготы при поступлении в МФТИ?", "options": ["ВсОШ", "«Физтех»\n(проводится МФТИ)", "«Курчатов»", "Все\nперечисленные"], "answer": 3},
        {"question": "Как расшифровывается ЗФТШ?", "options": ["Заочная\nфизико-техническая\nшкола", "Зимняя\nфизико-техническая смена", "Программа\nдля магистров", "Спортивный\nклуб МФТИ"], "answer": 0},
        {"question": "Какое минимальное количество баллов ЕГЭ по математике требуется для подачи документов в 2025 году?", "options": ["50", "70", "85", "Минимум не\nустановлен"], "answer": 2},
        {"question": "Как называется дополнительное вступительное испытание (ДВИ) в МФТИ?", "options": ["Собеседование\nпо физике", "Экзамен по\nматематике и физике", "Тест на IQ", "ДВИ отсутствует"], "answer": 3},
        {"question": "Какие программы помогают подготовиться к поступлению?", "options": ["Школы МФТИ", "Онлайн-курсы\nна Stepik", "ЗФТШ", "Все\nперечисленные"], "answer": 3},
        {"question": "Сколько этапов включает олимпиада «Физтех»?", "options": ["1 (только\nзаключительный)", "2 (отборочный\nи заключительный)", "3 (школьный,\nмуниципальный,\nвсероссийский)", "Олимпиада\nне проводится"], "answer": 1},
        {"question": "Что учитывается в портфолио абитуриента?", "options": ["Спортивные\nдостижения", "Баллы ЕГЭ", "Аттестат\nс отличием", "все"], "answer": 3},
        {"question": "Когда проходит «День открытых дверей» в МФТИ?", "options": ["Только зимой", "Весной и\nосенью", "Летом перед\nподачей документов", "Не проводится"], "answer": 1},
        {"question": "Какое преимущество дает победа в олимпиаде «Физтех»?", "options": ["Зачисление\nбез экзаменов", "100 баллов по\nпрофильному предмету", "Дополнительные\nбаллы к ЕГЭ", "Все перечисленные\nварианты"], "answer": 0},
        {"question": "Сколько абитуриентов поступило по БВИ в 2024 году?", "options": ["Больше 75%", "Меньше 50%\nно больше 25%", "Больше 50%\nно меньше 75%", "Меньше 25%"], "answer": 1},
    ],
]
